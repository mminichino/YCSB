 ...
 * </ul>
 */
public class CorePlusWorkload extends Workload {
  /**
  ...
  public void init(Properties p) throws WorkloadException {
    ...
    fieldlengthgenerator = CorePlusWorkload.getFieldLengthGenerator(p);
  ...
  public void doTransactionScan(DB db) {
    ...
    String startkeyname = CorePlusWorkload.buildKeyName(keynum, zeropadding, orderedinserts);
