...
do
  ...
  LOAD_OPTS="-db site.ycsb.db.azurecosmos.AzureCosmosSQLClient -P conf/db.properties -P $workload -threads $THREADCOUNT_LOAD -p recordcount=$RECORDCOUNT -s -load"
  RUN_OPTS="-db site.ycsb.db.azurecosmos.AzureCosmosSQLClient -P conf/db.properties -P $workload -threads $THREADCOUNT_RUN -p recordcount=$RECORDCOUNT -p operationcount=$OPCOUNT -p maxexecutiontime=$RUNTIME -s -t"
