...
do
  java -cp jdbc-binding/lib/jdbc-binding-0.18.0-SNAPSHOT.jar:lib/mssql-jdbc-12.4.0.jre11.jar site.ycsb.db.JdbcDBCreateTable -P conf/db.properties -n usertable
