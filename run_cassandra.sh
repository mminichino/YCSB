...
CLASSPATH="${SCRIPT_ROOT}/conf:${SCRIPT_ROOT}/lib/*:${SCRIPT_ROOT}/cassandra-binding/lib/*"
THREADCOUNT_LOAD=32
THREADCOUNT_RUN=256
RECORDCOUNT=1000000
OPCOUNT=10000000
...
do
  ...
  java -cp "$CLASSPATH" site.ycsb.db.cassandra.CassandraCleanup -p conf/db.properties
done
