...
public class SnowflakeCreateTable {
  ...
  private static void createTable(Properties props, String tablename) throws SQLException {
    String driver = props.getProperty(SnowflakeClient.DRIVER_CLASS);
    String username = props.getProperty(SnowflakeClient.CONNECTION_USER);
    String password = props.getProperty(SnowflakeClient.CONNECTION_PASSWD);
    String warehouse = props.getProperty(SnowflakeClient.CONNECTION_WAREHOUSE);
    String database = props.getProperty(SnowflakeClient.CONNECTION_DB);
    String schema = props.getProperty(SnowflakeClient.CONNECTION_SCHEMA);
    String url = props.getProperty(SnowflakeClient.CONNECTION_URL);
    int fieldcount = Integer.parseInt(props.getProperty(SnowflakeClient.FIELD_COUNT_PROPERTY,
        SnowflakeClient.FIELD_COUNT_PROPERTY_DEFAULT));
    ...
    try {
      ...
      sql.append(tablename);
      sql.append(" (RECORD INT AUTOINCREMENT,");
  ...
  public static void main(String[] args) {
    ...
    if (fieldcount > 0) {
      props.setProperty(SnowflakeClient.FIELD_COUNT_PROPERTY, String.valueOf(fieldcount));
    }
